  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
        <Link href="/timberRegulation/master/email-supervision" className="bg-white p-6 rounded-lg border border-slate-200 hover:border-[#967635] transition-colors cursor-pointer group block">
