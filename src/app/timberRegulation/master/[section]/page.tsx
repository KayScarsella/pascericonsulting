...
export default async function MasterSectionPage({
  ...
  if (section === 'users') {
    ...
    emailSupervisionRes = await getEmailSupervisionForTool(TIMBER_TOOL_ID, page, PAGE_SIZE, { q })
  }
  ...
  const basePath = `/timberRegulation/master/${section}`

  return (
    <div className="space-y-6">
      <Button variant="ghost" size="sm" asChild>
        <Link href="/timberRegulation/master" className="gap-1">
