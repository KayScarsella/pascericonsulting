    ...
    <div className="space-y-6">
      <div className="bg-slate-900 text-white p-6 rounded-lg shadow-lg flex items-center justify-between">
        <div>
          ...
          <p className="text-slate-300">Configurazione globale del sistema EUDR.</p>
        </div>
      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
        ...
        <Link href="/EUDR/master/species" className="bg-white p-6 rounded-lg border border-slate-200 hover:border-[#967635] transition-colors cursor-pointer group block">
          <div className="flex items-center gap-3 mb-4">
            <div className="p-2 bg-amber-50 rounded group-hover:bg-[#967635] transition-colors">
        ...
        <Link href="/EUDR/master/countries" className="bg-white p-6 rounded-lg border border-slate-200 hover:border-[#967635] transition-colors cursor-pointer group block">
          <div className="flex items-center gap-3 mb-4">
            <div className="p-2 bg-amber-50 rounded group-hover:bg-[#967635] transition-colors">
        ...
        <Link href="/EUDR/master/notifications" className="bg-white p-6 rounded-lg border border-slate-200 hover:border-[#967635] transition-colors cursor-pointer group block">
          <div className="flex items-center gap-3 mb-4">
            <div className="p-2 bg-amber-50 rounded group-hover:bg-[#967635] transition-colors">
